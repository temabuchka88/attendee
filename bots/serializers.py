        ...
        "properties": {
            ...
            "assembly_ai": {
                ...
                "properties": {
                    ...
                    "language_detection_options": {"type": "object", "properties": {"expected_languages": {"type": "array", "items": {"type": "string"}}, "fallback_language": {"type": "string"}}, "description": "Options for controlling the automatic language detection. See AssemblyAI docs for details."},
                },
                "additionalProperties": False,
            },
            "sarvam": {
